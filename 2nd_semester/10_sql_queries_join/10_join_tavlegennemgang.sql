...
SELECT 
	s.fName,s.lName,position,b.branchNo,b.street,b.city,
b.postcode, COUNT(p.propertyNo) AS numProAdmin
FROM Staff s 
...
SELECT
	Client.clientNo,fName, COUNT(Viewing.ID)
FROM Client
LEFT JOIN Viewing  ON Client.clientNo = Viewing.clientNo
